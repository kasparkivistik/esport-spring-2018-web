  ...
  div
    ...
    .container.content-block
      ...
      .row.is-flex.sponsors
        .col-xs-6: a(href="https://arvutitark.ee/"): img.img-responsive(src="../../assets/sponsors/arvutitark_logo.svg")
        .col-xs-6: a(href="https://www.msi.com"): img.img-responsive(src="../../assets/sponsors/msi-gaming.png")
        .col-xs-6: a(href="https://ttu.ee/itt"): img.img-responsive(src="../../assets/sponsors/itt.png")
        .col-xs-6: a(href="https://ituk.ee"): img.img-responsive(src="../../assets/sponsors/ituk.svg")
      .row.is-flex.sponsors-sm
        .col-xs-4.col-sm-3: a(href="https://noctua.at/"): img(src="../../assets/sponsors/noctua.jpg")
        .col-xs-4.col-sm-3: a(href="https://www.roccat.org"): img(src="../../assets/sponsors/roccat.jpg")
        .col-xs-4.col-sm-3: a(href="http://www.balsnack.ee/"): img(src="../../assets/sponsors/balsnack.svg")
        .col-xs-4.col-sm-3: a(href="https://wolt.com/"): img(src="../../assets/sponsors/wolt.png")
        .col-xs-4.col-sm-3: a(href="https://boom-esports.org/"): img(src="../../assets/sponsors/boommedia.png")
        .col-xs-4.col-sm-3: a(href="https://filmiklubi.ee/"): img(src="../../assets/sponsors/filmiklubi-03.svg")
        .col-xs-4.col-sm-3: a(href="https://www.monster.com/"): img(src="../../assets/sponsors/monster-02.svg")
        .col-xs-4.col-sm-3: a(href="http://www.tomorrow.ee/"): img(src="../../assets/sponsors/network_tomorrow.png")
        .col-xs-4.col-sm-3: a(href="https://www.academichostel.com"): img(src="../../assets/sponsors/academic_hostel.svg")
        .col-xs-4.col-sm-3: a(href="http://www.bytelife.com/"): img(src="../../assets/sponsors/bytelife.png")
        .col-xs-4.col-sm-3: a(href="http://www.exitroom.ee/"): img(src="../../assets/sponsors/exit_room.jpg")
        .col-xs-4.col-sm-3: a(href="https://www.ivpluss.ee/"): img(src="../../assets/sponsors/iveco.jpg")
        .col-xs-4.col-sm-3: a(href="https://ttu.ee/ye"): img(src="../../assets/sponsors/ye.jpg")
</template>
